...
urlpatterns = [
    ...
    url(r'^Predict_Tweet_Meesage_Type/$', remoteuser.Predict_Tweet_Meesage_Type, name="Predict_Tweet_Meesage_Type"),
    ...
    url(r'^Find_Predicted_Cyberbullying_Detection_Ratio/$', serviceprovider.Find_Predicted_Cyberbullying_Detection_Ratio, name="Find_Predicted_Cyberbullying_Detection_Ratio"),
    url(r'^Train_Test_DataSets/$', serviceprovider.Train_Test_DataSets, name="Train_Test_DataSets"),
    url(r'^View_Predicted_Cyberbullying_Detection_Type/$', serviceprovider.View_Predicted_Cyberbullying_Detection_Type, name="View_Predicted_Cyberbullying_Detection_Type"),
